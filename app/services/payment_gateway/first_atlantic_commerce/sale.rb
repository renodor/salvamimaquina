  ...
  module FirstAtlanticCommerce
    class Sale
      ...
      def initialize(order_info:, card_info:)
        @payload = payload(order_info: order_info, card_info: card_info)
      end
      ...
      def payload(order_info:, card_info:)
        {
          ...
          ExtendedData: {
            ...
            MerchantResponseUrl: "https://#{Rails.env.production? ? 'www.salvamimaquina.com' : '0a4e-78-120-155-254.ngrok.io'}/checkout/three_d_secure_response"
          }
        }.to_json
      end
    end
