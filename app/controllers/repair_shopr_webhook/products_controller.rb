...
class RepairShoprWebhook::ProductsController < ApplicationController
  ...
  def product_updated
    ...
    if params['attributes']['product_category']&.include?(RepairShoprApi::V1::Base::RS_ROOT_CATEGORY_NAME) && !params['attributes']['disabled']
      ...
      product = RepairShoprApi::V1::Base.get_product(params['attributes']['id']) # TODO: test if it works correctly
      RepairShoprApi::V1::SyncProduct.call(sync_logs: RepairShoprProductsSyncLog.new, attributes: product)
