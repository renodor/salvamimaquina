...
module Spree
  module TaxonsControllerDecorator
    ...
    def retrieve_products
      ...
      @products = @products.in_name_or_description(safe_params[:keywords]) if safe_params[:keywords].present?
    ...
    def product_filters_params
      params.permit(:per_page, :id, :sort_products, :keywords, scopes: {}, search: {}, price_between: [])
    end
