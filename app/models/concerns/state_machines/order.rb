...
# Copying the whole order state machine module ONLY to modify the transition transition to: :complete event...
# TODO: find a way to modify this event without having to copy the whole module
