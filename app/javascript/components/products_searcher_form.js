...
//     const productSearcherForms = document.querySelectorAll('.products-searcher-form');

//     // const allProductSearcherFormsData = () => {
//     //   const allQueryStrings = new URLSearchParams();
//     //   productSearcherForms.forEach((productSearcherForm) => {
//     //     const formData = new FormData(productSearcherForm);
//     //     for (const [key, value] of formData) { allQueryStrings.append(key, value); }
//     //   });

//     //   return allQueryStrings.toString();
//     // };

//     // productSearcherForms.forEach((productSearcherForm) => {
//     //   productSearcherForm.addEventListener('change', (event) => {
//     //     const url = new URL(window.location);
//     //     url.search = allProductSearcherFormsData();
//     //     his
//     //     // const request = new XMLHttpRequest();
//     //     // request.open('GET', formAction);
//     //     // request.send();
...
//     // productSearcherForms.forEach((productSearcherForm) => {
//     //   productSearcherForm.addEventListener('formdata', (event) => {
//     //     const currentFormData = event.formData;

//     //     productSearcherForms.forEach((otherForm) => {
//     //       if (otherForm === productSearcherForm) { return; }

//     //       // debugger
//     //       const formData = new FormData(otherForm);
//     //       // for (const [key, value] of formData) { currentFormData.append(key, value); }
//     //     });
//     //   });
//     // });

//     // productSearcherForms.forEach((productSearcherForm) => {
//     //   [...productSearcherForm.elements].forEach((formElement) => {
//     //     formElement.addEventListener('change', (event) => {
//     //       // maybe submit form
//     //     });
//     //   });
